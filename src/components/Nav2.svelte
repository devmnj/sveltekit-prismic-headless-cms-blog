<nav   class="relative bg-white shadow dark:bg-gray-800 sticky top-0">
    <div class="container px-6 py-4 mx-auto md:flex md:justify-between md:items-center">
        <div class="flex items-center justify-between">
            ...
            <div class="flex lg:hidden">
                <button x-cloak on.click={isOpen = !isOpen} type="button" class="text-gray-500 dark:text-gray-200 hover:text-gray-600 dark:hover:text-gray-400 focus:outline-none focus:text-gray-600 dark:focus:text-gray-400" aria-label="toggle menu">
