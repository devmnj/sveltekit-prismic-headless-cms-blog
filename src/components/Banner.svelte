    ...
    <section class="">
      <div class="bg-slate-600 alert alert-dismissible fade show fixed top-0 right-0 left-0 z-[1030] w-full py-2 px-6 text-white md:flex justify-between items-center text-center md:text-left">
        <div class="mb-1 md:mb-0 flex items-center flex-wrap justify-center md:justify-start">
          ...
          <strong class="mr-1">Crafted  </strong>beautifully with <a href="https://kit.svelte.dev/" target="_blank" rel="noreferrer" class="text-orange-300 px-2" >SvelteKit</a> and Powered By  <a class="text-pink-300 px-2" href="http://prismic.io" target="_blank" rel="noreferrer" > Prismic </a> 
        </div>
      </div>
